...
docker build -f ./dockerfiles/amd64-server-base.Dockerfile -t arm64-server-base .

cd ..

docker build --build-arg ENV=%2 --build-arg STAGE_ENV=%2 -f ./docker/dockerfiles/%1.Dockerfile -t %1:%2 .
